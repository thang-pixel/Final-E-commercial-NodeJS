                ...
                <Row justify="space-between" align="middle">
                    <Col>
                        <Select
                            ...
                            style={{ width: 200 }}
                        >
                            <Option value={PRODUCT_STATUS.ACTIVE.value}>{PRODUCT_STATUS.ACTIVE.label}</Option>
                            <Option value={PRODUCT_STATUS.INACTIVE.value}>{PRODUCT_STATUS.INACTIVE.label}</Option>
                            <Option value={PRODUCT_STATUS.OUT_OF_STOCK.value}>{PRODUCT_STATUS.OUT_OF_STOCK.label}</Option>
                        </Select>
                    </Col>
                    <Col>
